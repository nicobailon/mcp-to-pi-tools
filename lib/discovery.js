...
import { buildMcpCommand as buildCommand, fetchPackageDescription } from "./runner.js";
 ...
 * @param {string} options.command - Explicit command override
 * @returns {Promise<{serverName: string, mcpCommand: string, tools: Array<{name: string, description?: string, inputSchema?: object}>, runner: string, description: string|undefined}>}
 */
