 ...
 */
export function printSuccess(outputDir, toolCount) {
  console.log(`
Done! To install:
  cd ${outputDir} && ./install.sh

Generated ${toolCount} wrapper scripts.
Copy AGENTS-ENTRY.md content to ~/.pi/agent/AGENTS.md to register with Pi.
`);
}
